...
# Commented out BCI - using test mode
EEG_AVAILABLE = False
BrainFlowBoardSetup = None
BoardIds = None
...
# ---------------- EEG utilities (commented out for test) ---------------- #
...
#     alpha_band = bands.get("alpha", (8, 12))
#     beta_band = bands.get("beta", (12, 30))

#     eeg = np.asarray(eeg_data)
#     if eeg.ndim == 1:
#         eeg = eeg[None, :]  # (1, n_samples)
...
def main(serial_port: str = None):
    ...
    pygame.display.set_caption("Red Light Green Light - Alpha Test (Fullscreen)")
    ...
    # Running normalization stats (Welford) - commented out
    # rs_count = 0
    # rs_mean = 0.0
    # rs_m2 = 0.0
    # strength_ema = 0.0
    # strength_ema_alpha = 0.15  # smoothing factor for control

    # Commented out EEG setup
    # if EEG_AVAILABLE:
    #     try:
...
if __name__ == "__main__":
    # Test mode - no serial port needed
